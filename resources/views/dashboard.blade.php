              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--danger">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">{{$customer[0]->Cuscount}}</h5>
                    <p class="tx-12 text-muted">55% Customer</p>
                    <div class="card-icon-wrapper">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--primary">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">{{$vendorproduct[0]->Vproduct}}</h5>
                    <p class="tx-12 text-muted">87% Vendor Product</p>
                    <div class="card-icon-wrapper">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
                <div class="mdc-card info-card info-card--info">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">{{$error[0]->Ecount}}</h5>
                    <p class="tx-12 text-muted">10% Error</p>
                    <div class="card-icon-wrapper">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet " >
                <div class="mdc-card info-card info-card--info">
                  <div class="card-inner">
                    ...
                    <h5 class="font-weight-light pb-2 mb-1 border-bottom">{{$result[0]->remain}}</h5>
                    <p class="tx-12 text-muted">90% Reminder </p>
                    <div class="card-icon-wrapper " style="background-color:black;">
